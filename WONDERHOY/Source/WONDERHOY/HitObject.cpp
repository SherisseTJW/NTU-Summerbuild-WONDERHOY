...
AHitObject::AHitObject()
{
	...
	static ConstructorHelpers::FClassFinder<AActor> Character_Emu(TEXT("/Game/Assets/Characters/BP_Character_Emu"));
	static ConstructorHelpers::FClassFinder<AActor> Character_Fishkasa(TEXT("/Game/Assets/Characters/BP_Character_Fishkasa"));
	static ConstructorHelpers::FClassFinder<AActor> Character_Robone(TEXT("/Game/Assets/Characters/BP_Character_Robone"));
	static ConstructorHelpers::FClassFinder<AActor> Character_Pandui(TEXT("/Game/Assets/Characters/BP_Character_Pandui"));

	TArray<UClass*> CharacterClasses;
    CharacterClasses.Add(Character_Emu.Class);
    CharacterClasses.Add(Character_Fishkasa.Class);
    CharacterClasses.Add(Character_Robone.Class);
    CharacterClasses.Add(Character_Pandui.Class);
