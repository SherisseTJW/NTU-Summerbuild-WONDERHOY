...
beatmap::HitObject::Judgement beatmap::HitObject::setJudgement(int _time){
    int diff = abs(_time - this->time);
    if(diff < 60){
...
beatmap::HitObject::Judgement beatmap::HitObject::setJudgement(int _time, bool followed){
    beatmap::HitObject::Judgement judgement = setJudgement(_time);
